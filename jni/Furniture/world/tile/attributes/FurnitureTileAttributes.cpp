...
FurnitureTileAttributes::FurnitureTileAttributes(const Material& realMaterial, std::string ptexture, std::string stexture, const Block::SoundType& sounds, float hardness):
