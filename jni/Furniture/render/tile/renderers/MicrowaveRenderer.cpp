...
void MicrowaveRenderer::render(const TilePos& pos, FurnitureTile* tile, TileTessellator* tess) {
	...
	tess->setRotatedBounds(tess, data, 0.1875F, 0.0F, 0.0625F, 0.25F, 0.0625F, 0.75F);
	tess->tessellateBlockInWorld(tile, {x, y, z});
	tess->setRotatedBounds(tess, data, 0.1875F, 0.4375F, 0.0625F, 0.25F, 0.5F, 0.75F);
	tess->tessellateBlockInWorld(tile, {x, y, z});
	tess->setRotatedBounds(tess, data, 0.1875F, 0.0625F, 0.0625F, 0.25F, 0.4375F, 0.125F);
	tess->tessellateBlockInWorld(tile, {x, y, z});
	tess->setRotatedBounds(tess, data, 0.1875F, 0.0625F, 0.6875F, 0.25F, 0.4375F, 0.75F);
	tess->tessellateBlockInWorld(tile, {x, y, z});

	tess->forcedUV = tile->getTexture(1, 0);
	tess->setRotatedBounds(tess, data, 0.1875F, 0.0F, 0.78125F, 0.25F, 0.5F, 0.9375F);
	tess->tessellateBlockInWorld(tile, {x, y, z});
	...
	tess->forcedUV = tile->getTexture(2, 0);
	tess->setRotatedBounds(tess, data, 0.265625F, 0.0625F, 0.1875F, 0.625F, 0.125F, 0.640625F);
	tess->tessellateBlockInWorld(tile, {x, y, z});
}